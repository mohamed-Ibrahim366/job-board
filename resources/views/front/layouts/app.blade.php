...
<head>
	...
	<title>Job Board | Find Best Jobs</title>
	...
	<!-- Fav Icon -->
	<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/images/banner-2.jpg') }}" />
</head>
...
<div class="container">
    <p class="text-center text-white pt-3 fw-bold fs-6"> all rights reserved for Eng. MOhamed Ibrahim © 2024 </p>
</div>
</footer>
